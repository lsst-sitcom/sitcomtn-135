...
pipetask run -b /sdf/group/rubin/repo/aos_imsim/ -i refcats,LSSTComCamSim/raw/all,LSSTComCamSim/calib/unbounded --instrument lsst.obs.lsst.LsstComCamSim --register-dataset-types -o sitcomtn-135/directDetectTimingTest -p science_direct_detect_no_mag_limit.yaml -d "detector IN (0..9) AND instrument='LSSTComCamSim' and visit IN (7024072600012, 7024072600010)" -j 18
